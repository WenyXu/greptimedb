...
pub fn deocde_batch_stream<T: Send + 'static>(
...
impl MetadataRegion {
    ...
    pub async fn get_all_with_prefix(
        ...
        deocde_batch_stream(record_batch_stream, decode_record_batch_to_key_and_value)
    ...
    pub async fn get_all_key_with_prefix(
        ...
        deocde_batch_stream(record_batch_stream, decode_record_batch_to_key)
            .try_collect::<Vec<_>>()
            .await
    }
